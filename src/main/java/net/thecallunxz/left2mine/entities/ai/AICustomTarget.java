...
public abstract class AICustomTarget extends EntityAIBase {
   ...
   public AICustomTarget(EntityCreature creature, boolean checkSight) {
      this(creature, checkSight, false);
   }

   public AICustomTarget(EntityCreature creature, boolean checkSight, boolean onlyNearby) {
         ...
         if (team != null && team1 == team) {
            ...
            if (this.taskOwner.getDistanceSq(entitylivingbase) > d0 * d0) {
               ...
               if (this.shouldCheckSight) {
                  if (Left2MineUtilities.canEntitySeeEntity(this.taskOwner, entitylivingbase, this.taskOwner.world)) {
   ...
   public static boolean isSuitableTarget(EntityLiving attacker, @Nullable EntityLivingBase target, boolean includeInvincibles, boolean checkSight) {
      if (target == null) {
         ...
         return !checkSight || Left2MineUtilities.canEntitySeeEntity(attacker, target, attacker.getEntityWorld());
      }
   }
   ...
   public AICustomTarget setUnseenMemoryTicks(int p_190882_1_) {
