...
public class WitchCorpse extends CustomCorpse {
   public WitchCorpse() {
      super(ModelWitch.class);
   }
   ...
   public RagdollBase getSkeleton(Entity argEntity, ModelBase argModel) {
      ...
      if (((EntityWitch)argEntity).getAttackingState() == 0) {
         ...
         nodeRightLeg = new RagdollLimb(1.0F, 0.0F - 2.0F * s, 0.0F + 12.0F * s, 0.0F + 24.0F * s);
         nodeLeftLeg = new RagdollLimb(1.0F, 0.0F + 2.0F * s, 0.0F + 12.0F * s, 0.0F + 24.0F * s);
