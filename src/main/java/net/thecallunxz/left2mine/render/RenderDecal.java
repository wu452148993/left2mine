...
public class RenderDecal extends Render<EntityDecal> {
   public static final RenderDecal.Factory FACTORY = new RenderDecal.Factory();
   ...
   public void doRenderDecal(EntityDecal var1, double var2, double var4, double var6, float var8, float var9) {
      ...
      if (var1 instanceof EntityBulletHole || var1 instanceof EntityScorch) {
   ...
   private void renderDecalSingleFloor(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, double p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_, BufferBuilder vertexbuffer) {
      boolean bool = false;
      if (state.getBlock() instanceof BlockFakeWall) {
         bool = state.getValue(BlockFakeWall.FACING) == EnumFacing.UP;
      } else {
   ...
   private void renderDecalSingleNorth(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, double p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
      ...
      double offset = 0.0D;
      if (state.getBlock() instanceof BlockFakeWall) {
         bool = state.getValue(BlockFakeWall.FACING) == EnumFacing.NORTH;
         offset = 0.82D;
      } else {
      ...
      if (bool) {
         ...
         if (d0 >= 0.0D) {
            ...
            vertexbuffer.pos(x2, y1, z1 - offset).tex((double)f1, (double)f2).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x2, y2, z1 - offset).tex((double)f1, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x1, y2, z1 - offset).tex((double)f, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x1, y1, z1 - offset).tex((double)f, (double)f2).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
         }
      } else if (state.getBlock() instanceof BlockSlab || state.getBlock() instanceof BlockStairs) {
         tessellator = Tessellator.getInstance();
         vertexbuffer = tessellator.getBuffer();
         ...
         if (d0 >= 0.0D) {
            ...
            if (state.getBlock() instanceof BlockStairs) {
               ...
               if (facing == EnumFacing.NORTH) {
                  ...
                  f = (float)((p_188299_2_ - x1) / 2.0D / p_188299_10_ + 0.5D);
                  float f1 = (float)((p_188299_2_ - x2) / 2.0D / p_188299_10_ + 0.5D);
                  float f2 = (float)((p_188299_4_ - y1) / 2.0D / p_188299_10_ + 0.5D);
                  float f3 = (float)((p_188299_4_ - y2) / 2.0D / p_188299_10_ + 0.5D);
   ...
   private void renderDecalSingleEast(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, double p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
      ...
      double offset = 0.0D;
      if (state.getBlock() instanceof BlockFakeWall) {
         bool = state.getValue(BlockFakeWall.FACING) == EnumFacing.EAST;
         offset = 0.82D;
      } else {
      ...
      if (bool) {
         ...
         if (d0 >= 0.0D) {
            ...
            vertexbuffer.pos(x2 + offset, y1, z2).tex((double)f, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x2 + offset, y2, z2).tex((double)f1, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x2 + offset, y2, z1).tex((double)f1, (double)f2).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x2 + offset, y1, z1).tex((double)f, (double)f2).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
         }
      } else if (state.getBlock() instanceof BlockSlab || state.getBlock() instanceof BlockStairs) {
         tessellator = Tessellator.getInstance();
         vertexbuffer = tessellator.getBuffer();
         ...
         if (d0 >= 0.0D) {
            ...
            if (state.getBlock() instanceof BlockStairs) {
               ...
               if (facing == EnumFacing.EAST) {
                  ...
                  f = (float)((p_188299_4_ - y1) / 2.0D / p_188299_10_ + 0.5D);
                  float f1 = (float)((p_188299_4_ - y2) / 2.0D / p_188299_10_ + 0.5D);
                  float f2 = (float)((p_188299_6_ - z1) / 2.0D / p_188299_10_ + 0.5D);
                  float f3 = (float)((p_188299_6_ - z2) / 2.0D / p_188299_10_ + 0.5D);
   ...
   private void renderDecalSingleSouth(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, double p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
      ...
      double offset = 0.0D;
      if (state.getBlock() instanceof BlockFakeWall) {
         bool = state.getValue(BlockFakeWall.FACING) == EnumFacing.SOUTH;
         offset = 0.82D;
      } else {
      ...
      if (bool) {
         ...
         if (d0 >= 0.0D) {
            ...
            vertexbuffer.pos(x1, y2, z2 + offset).tex((double)f, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x2, y2, z2 + offset).tex((double)f1, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
   ...
   private void renderDecalSingleWest(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, double p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
      ...
      double offset = 0.0D;
      if (state.getBlock() instanceof BlockFakeWall) {
         bool = state.getValue(BlockFakeWall.FACING) == EnumFacing.WEST;
         offset = 0.82D;
      } else {
      ...
      if (bool) {
         ...
         if (d0 >= 0.0D) {
            ...
            vertexbuffer.pos(x1 - offset, y2, z2).tex((double)f1, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x1 - offset, y1, z2).tex((double)f, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
         }
      } else if (state.getBlock() instanceof BlockSlab || state.getBlock() instanceof BlockStairs) {
         tessellator = Tessellator.getInstance();
         vertexbuffer = tessellator.getBuffer();
         ...
         if (d0 >= 0.0D) {
            ...
            vertexbuffer.pos(x1, y2, z2).tex((double)f1, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
            vertexbuffer.pos(x1, y1, z2).tex((double)f, (double)f).color(1.0F, 1.0F, 1.0F, (float)d0).normal(0.0F, 0.0F, 0.0F).endVertex();
         }
      }

   }

   public static class Factory implements IRenderFactory<EntityDecal> {
      public Render<? super EntityDecal> createRenderFor(RenderManager manager) {
