...
public class ItemAutoShotgun extends ItemGun {
   public static GunProperties gun = new GunProperties() {
      public void setProperties() {
         ...
         this.fireSound = InitSounds.autoshotgun_fire;
   ...
   public ItemAutoShotgun(String name, ItemBase.EnumItemType type) {
