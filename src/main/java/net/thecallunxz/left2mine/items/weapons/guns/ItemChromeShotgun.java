...
public class ItemChromeShotgun extends ItemGun {
   public static GunProperties gun = new GunProperties() {
      public void setProperties() {
         ...
         this.fireSound = InitSounds.chromeshotgun_fire;
   ...
   public ItemChromeShotgun(String name, ItemBase.EnumItemType type) {
