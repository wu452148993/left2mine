...
public class BlockZombieSpawn extends BlockNodeChild {
   public BlockZombieSpawn(String name) {
      super(name);
   }
   ...
   public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
      if (worldIn.getBlockState(pos.down()).getBlock() != InitBlocks.zombiespawn) {
