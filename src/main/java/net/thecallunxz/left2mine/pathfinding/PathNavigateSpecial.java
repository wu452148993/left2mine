...
public class PathNavigateSpecial extends PathNavigateGround {
   private boolean shouldAvoidSun;

   public PathNavigateSpecial(EntityLiving entitylivingIn, World worldIn) {
      super(entitylivingIn, worldIn);
   }

   protected PathFinder getPathFinder() {
      this.nodeProcessor = new WalkCustomDoorProcessor();
   ...
   public Path getPathToPos(BlockPos pos) {
      ...
      if (this.world.getBlockState(pos).getMaterial() == Material.AIR) {
         for(blockpos1 = pos.down(); blockpos1.getY() > 0 && this.world.getBlockState(blockpos1).getMaterial() == Material.AIR; blockpos1 = blockpos1.down()) {
         }
         ...
         while(blockpos1.getY() < this.world.getHeight() && this.world.getBlockState(blockpos1).getMaterial() == Material.AIR) {
