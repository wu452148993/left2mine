...
void main() {
    float xOffset = sin(texCoord.y * Frequency.x + Time * 3.1415926535 * 1.0) * WobbleAmount.x;
    float yOffset = cos(texCoord.x * Frequency.y + Time * 3.1415926535 * 1.0) * WobbleAmount.y;
